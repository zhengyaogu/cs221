.data
    prompt1: .asciiz "Enter the character you want to count and press Enter: "
    prompt2: .asciiz "The number of your character in the string is "
    prompt3: .asciiz "\nThe string is \"gutentag\"!"
    str: .asciiz "gutentag"
    buffer: .space 3
    main_return: .word 0
.text
